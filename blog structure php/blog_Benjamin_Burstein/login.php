...
<html lang="en">
  ...
  <body>
    ...
    <h1>LOGIN</h1>
    <form action="verifLogin.php" method="POST" enctype="multipart/form-data" id="form">
      ...
      <button id="check" type="submit" class="btn btn-primary">Be connect</button>
    </form>
    <?php
      if(isset($_GET['error']) && $_GET['error']) 
      {
        echo '<h2 style="color: red;">Login incorrect !</h2>';
      } 
    ?>
  </body>
</html>